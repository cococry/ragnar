...
#define WINDOW_BORDER_COLOR_HARD_SELECTED       0xc1d4d9 // Color of window border for hard-selected windows
...
#define BAR_INSTANT_UPDATE                      false // Turning this off can save performace, as it only updates the bar if events happen
...
#define BAR_INFO_LABEL_SELECTED_COLOR           0x152d38
...
#define BAR_BUTTON_COUNT                        3 // Count of buttons on the bar-button-label
