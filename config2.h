...
{ 
    (BarCommand){.cmd = "echo \"󰣇 + RGNR\"", .color = "#ffffff", .bg_color = -1},
    (BarCommand){.cmd = "echo \"  $(date +%R)\"", .color = "#ffffff", .bg_color = -1},
    (BarCommand){.cmd = "ram-ragbar", .color = "#ffffff", .bg_color = -1},
    (BarCommand){.cmd = "uptime-ragbar", .color = "#ffffff", .bg_color = -1},
};
